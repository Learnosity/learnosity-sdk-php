    ...
    public function preHashStringProvider()
    {
        ...
        $preHashStrings = [
            false => [
                ...
                'author-aide' => 'yis0TYCu7U9V4o7M_localhost_20140626-0528_{"config":{"test-attribute":"test"},"user":{"id":"walterwhite","firstname":"walter","lastname":"white"}}',
            ...
            true => [
                ...
                'author-aide' => null, /* no need for v1 compat, let's make this explicit */
